...
if [ "$main" -lt 5 ]|| [ "$minor" -lt 6 ]; then 
if [[  bitvisuev  == "kvm" ||  bitvisuev  == "xen" ||  bitvisuev  == "microsoft" ]]; then
yellow "内核小于5.6版本，安装WARP内核模块模式"
...
if [[  bitvisuev  == "x86_64" ]]; then
wget -N https://cdn.jsdelivr.net/gh/用户名/CFwarp/wgcf_2.2.9_amd64 -O /usr/local/bin/wgcf && chmod +x /usr/local/bin/wgcf         
elif [[  bitvisuev  == "aarch64" ]]; then
wget -N https://cdn.jsdelivr.net/gh/用户名/CFwarp/wgcf_2.2.9_arm64 -O /usr/local/bin/wgcf && chmod +x /usr/local/bin/wgcf
fi
if [[  bitvisuev  == "lxc" ||  bitvisuev  == "openvz" ]]; then
wget -N https://cdn.jsdelivr.net/gh/用户名/CFwarp/wireguard-go -O /usr/bin/wireguard-go && chmod +x /usr/bin/wireguard-go
fi
...
wget -N --no-check-certificate https://cdn.jsdelivr.net/gh/用户名/CFwarp/sip.sh >/dev/null 2>&1
...
wget -N --no-check-certificate https://cdn.jsdelivr.net/gh/用户名/warp-plus/wp.py
python3 wp.py
}

function upcore(){
wget -N --no-check-certificate https://cdn.jsdelivr.net/gh/用户名/CFwarp/ucore.sh && chmod +x ucore.sh && ./ucore.sh
}
...
function up4(){
wget -N --no-check-certificate https://raw.githubusercontent.com/用户名/CFwarp/main/CFwarp.sh && chmod +x CFwarp.sh && ./CFwarp.sh
}
